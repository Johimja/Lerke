...
-- Extends get_avatar_item_cost() to include acc_* keys.
-- The existing purchase_avatar_item() RPC already handles
-- any key generically, so only the cost helper needs updating.
--
-- Run after V19b (supabase_bingo_v19b_reset_pin_login_code_patch.sql)
-- =========================================================
...
as $$
  select case p_item_key
    -- Head items (unchanged from V17/V18)
