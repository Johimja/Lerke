...
-- =========================================================
-- Avatar-7 introduced the head-accessory layer (media/avatar_head_accessories.png)
-- with all acc_* keys priced free (xp:0) as a placeholder. This patch gives
-- get_avatar_item_cost real costs for the 19 non-free accessories so the
-- existing generic purchase_avatar_item(p_item_key) RPC can sell them.
-- No schema changes — only the cost lookup function is replaced.
-- =========================================================
