-- =========================================================
-- V20: Avatar accessories XP costs
-- =========================================================
-- Extends get_avatar_item_cost to return XP costs for acc_* keys.
-- The existing purchase_avatar_item RPC already handles any key via
-- get_avatar_item_cost, so no changes to the purchase flow are needed.
--
-- Accessories that are free (acc_none) return 0.
-- All other accessories are unlockable with XP just like face shapes.
-- =========================================================
