...
-- Avatar-7 added the accessory layer with all items free (xp:0).
-- This patch extends the existing get_avatar_item_cost() helper so acc_*
-- keys carry real XP costs. purchase_avatar_item() already works generically
-- against this helper (Avatar-1/V17), so no RPC changes are needed — only
-- the cost table.
-- =========================================================
