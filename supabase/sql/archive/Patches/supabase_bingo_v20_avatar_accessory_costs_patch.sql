-- =========================================================
-- V20: Avatar head-accessory XP costs (Avatar-8)
-- =========================================================
-- Avatar-7 added the acc_* layer to the frontend with all accessories
-- free (xp:0). This patch extends the existing server-side cost helper
-- so `purchase_avatar_item` can validate and charge XP for acc_* keys
-- too — no new RPC needed, `purchase_avatar_item` already resolves any
-- item key through `get_avatar_item_cost`.
--
-- Costs mirror the ACCESSORY_CATALOGUE xp values in index.html.
-- =========================================================
