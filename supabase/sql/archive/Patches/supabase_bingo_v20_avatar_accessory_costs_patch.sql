...
-- This patch gives get_avatar_item_cost() real costs for acc_* keys so
-- purchase_avatar_item() (already generic — works for any key it can price)
-- charges XP and unlocks accessories the same way it already does for heads.
-- No change needed to purchase_avatar_item itself.
-- =========================================================
