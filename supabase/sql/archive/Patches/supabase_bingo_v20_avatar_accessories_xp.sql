...
-- purchase_avatar_item() is unchanged — it calls this helper
-- generically and handles acc_* items the same as head items.
--
-- acc_none is always free (xp=0) so it can be equipped by any student.
-- =========================================================
...
as $$
  select case p_item_key
    -- ── Face shapes (from avatar_faceshapes.png) ──────────────
    ...
    -- ── Head accessories (from avatar_head_accessories.png) ───
