...
-- =========================================================
-- Avatar-7 added the head-accessory layer with all acc_* keys
-- free (xp:0). This patch assigns real XP costs server-side and
-- extends get_avatar_item_cost() so purchase_avatar_item() can
-- validate and charge for acc_* keys exactly like head_* keys.
-- No new RPC needed — purchase_avatar_item() is already generic.
-- =========================================================
