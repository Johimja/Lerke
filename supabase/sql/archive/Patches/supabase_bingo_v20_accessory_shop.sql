-- =========================================================
-- supabase_bingo_v20_accessory_shop.sql
-- Adds XP costs for head accessories (acc_* keys).
-- Extends get_avatar_item_cost() to recognise acc_* keys.
-- The existing purchase_avatar_item RPC is unchanged — it
-- already validates cost, deducts XP, and appends to
-- unlocked_avatar_items for any key this helper returns a
-- non-null value for.
-- =========================================================
...
as $$
  select case p_item_key
    -- head shapes (face-shape sheet, avatar_faceshapes.png)
