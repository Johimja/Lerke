-- =========================================================
-- V20: Avatar accessories shop — XP costs for acc_* items
-- =========================================================
-- Extends get_avatar_item_cost() to include all acc_* keys so that
-- the existing purchase_avatar_item() RPC can validate and deduct XP
-- when a student purchases a head accessory.
--
-- acc_none is always free (0 XP).
-- Costs are tiered by rarity/fanciness:
--   25 XP  — basic everyday items
--   50 XP  — medium accessories
--   75 XP  — notable/fun accessories
--  100 XP  — fancy accessories
--  125 XP  — premium accessories
--  150 XP  — rare accessories
--  175 XP  — legendary accessories
-- =========================================================
...
as $$
  select case p_item_key
    -- Head / face-shape silhouettes (v17 original)
