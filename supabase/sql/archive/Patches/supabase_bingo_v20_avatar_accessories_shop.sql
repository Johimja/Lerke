...
-- =========================================================
-- Extends get_avatar_item_cost() to return non-zero costs for
-- acc_* keys so purchase_avatar_item() validates and deducts XP.
-- No schema changes needed — purchase_avatar_item already works
-- for any key type returned by get_avatar_item_cost().
-- =========================================================

-- =========================================================
-- 1. Replace immutable cost helper to include acc_* items
-- =========================================================
...
as $$
  select case p_item_key
    -- Head / face-shape silhouettes (unchanged from v17/v18)
