-- =========================================================
-- V20: Head accessory shop — XP costs for acc_* items
-- =========================================================
-- Extends get_avatar_item_cost to recognise all 20 acc_* keys
-- with XP costs. The existing purchase_avatar_item RPC handles
-- acc_* purchases automatically once this function returns valid
-- costs for those keys. No other RPCs or schema changes needed.
-- =========================================================
