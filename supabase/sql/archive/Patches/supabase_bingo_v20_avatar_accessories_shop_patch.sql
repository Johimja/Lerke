-- Avatar-8: Head accessories shop — add XP costs to acc_* items
-- Replaces get_avatar_item_cost() to include all 20 accessory keys.
-- purchase_avatar_item() calls this helper and needs no changes.
-- Apply after supabase_bingo_v18_avatar_faceshapes.sql.
