-- =============================================================
-- Lerke Bingo — v20 Avatar Accessories Shop patch
-- Extends get_avatar_item_cost() to include all acc_* keys.
-- purchase_avatar_item() already handles any key whose cost
-- is returned by this function, so no RPC changes are needed.
-- =============================================================
