...
-- Applied: 2026-06-10
-- =========================================================
-- Extends get_avatar_item_cost() with acc_* case branches so
-- purchase_avatar_item() validates and charges XP for accessories.
-- No schema changes needed — the existing column, RPC, and
-- unlocked_avatar_items array already handle arbitrary item keys.
-- =========================================================
