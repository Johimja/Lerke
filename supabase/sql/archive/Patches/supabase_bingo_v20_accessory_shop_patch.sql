-- =========================================================
-- V20 Patch: Accessory shop XP costs
-- =========================================================
-- Extends get_avatar_item_cost() to include all acc_* keys
-- from the 20-item head-accessories sheet (Avatar-8).
-- purchase_avatar_item() requires no changes — it already
-- validates any key through get_avatar_item_cost().
-- =========================================================
