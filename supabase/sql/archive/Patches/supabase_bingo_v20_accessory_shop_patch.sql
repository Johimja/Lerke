...
-- =========================================================
-- Extends get_avatar_item_cost to include acc_* keys so that
-- the existing purchase_avatar_item RPC handles accessories.
-- acc_none is always free (0 XP, no purchase needed).
-- =========================================================
...
as $$
  select case p_item_key
    -- Head shapes (unchanged from v17/v18)
