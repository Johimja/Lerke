-- =========================================================
-- V20: Head accessories XP costs (Avatar-8)
-- =========================================================
-- Extends get_avatar_item_cost() to handle acc_* keys so that
-- purchase_avatar_item() can charge XP for accessory items.
-- No schema changes needed — purchase_avatar_item already routes
-- through get_avatar_item_cost for validation and cost lookup.
-- =========================================================
...
as $$
  select case p_item_key
    -- Head / face-shape silhouettes (v17)
