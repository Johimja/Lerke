...
-- purchase_avatar_item() needs no changes — it already deducts
-- XP and appends any valid key to unlocked_avatar_items[].
-- acc_none is always free and never needs purchasing.
-- =========================================================
