-- =========================================================
-- Lerke Bingo v20 — Avatar accessory shop (Avatar-8)
-- Extends get_avatar_item_cost to recognise acc_* keys so
-- purchase_avatar_item can charge XP for head accessories.
-- acc_none is always free (cost 0). All 19 paid accessories
-- have explicit costs that match the frontend ACCESSORY_CATALOGUE.
-- =========================================================
