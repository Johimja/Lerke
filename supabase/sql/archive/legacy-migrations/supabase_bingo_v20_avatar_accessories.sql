...
-- =========================================================
-- Extends get_avatar_item_cost() to cover the 20 head-accessory
-- keys from ACCESSORY_CATALOGUE (avatar_head_accessories.png).
-- purchase_avatar_item() already handles any key validated by
-- get_avatar_item_cost(), so no changes to that RPC are needed.
-- =========================================================
