-- =========================================================
-- Lerke Bingo — v20: Avatar accessories XP costs
-- =========================================================
-- Extends get_avatar_item_cost() to include all acc_* keys from
-- the 20-item head accessories sheet (media/avatar_head_accessories.png).
-- purchase_avatar_item() is already generic and requires no changes.
-- =========================================================
...
as $$
  select case p_item_key
    -- Head face-shapes (from v18 canonical sheet)
    ...
    -- Head accessories (from v20 sheet, avatar_head_accessories.png)
