...
-- >>> BEGIN FILE: supabase_bingo_v20_avatar_accessory_costs.sql
-- =========================================================
-- V20: Avatar head accessory XP costs (Avatar-8)
-- =========================================================
-- Extends get_avatar_item_cost() with acc_* keys so
-- purchase_avatar_item() can validate and charge for head
-- accessories exactly like head_* keys. No new RPC needed.
-- =========================================================
