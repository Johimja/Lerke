...
-- =========================================================
-- V20: XP costs for head accessories (Avatar-8)
-- =========================================================
-- Spritesheet: /media/avatar_head_accessories.png (1024×1280, 4 cols × 5 rows, 256×256/cell)
-- Avatar-7 shipped the layered accessory renderer with all acc_* items free (xp:0).
-- This adds real costs for acc_* keys to get_avatar_item_cost() so
-- purchase_avatar_item() (already generic) charges XP and unlocks accessories
-- the same way it already does for heads. No change needed to purchase_avatar_item itself.
-- =========================================================
