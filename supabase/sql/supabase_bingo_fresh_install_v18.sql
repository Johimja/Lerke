...
-- =========================================================
-- >>> BEGIN FILE: supabase_bingo_v21_avatar_color_change.sql
-- =========================================================
-- V21: Paid avatar color changes (Avatar-9)
-- Students pay 25 XP to set a custom color (#rrggbb) on their avatar
-- silhouette. The color is stored in avatar_data.color via the existing
-- save_student_avatar() RPC after a successful purchase_avatar_color() call.
...
-- <<< END FILE: supabase_bingo_v21_avatar_color_change.sql
