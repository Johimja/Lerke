...
-- >>> BEGIN FILE: supabase_bingo_v20_avatar_accessory_costs_patch.sql (kept in sync, see archive/Patches)
-- V20 / Avatar-8: head accessory XP costs — folded into get_avatar_item_cost above.
