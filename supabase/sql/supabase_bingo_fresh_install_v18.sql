...
-- =========================================================
-- v21: purchase_avatar_color — paid skin/accessory color changes
-- Valid slots: 'skinColor', 'accColor'. Cost: 25 XP.
-- Null/empty color = free reset (removes key from avatar_data).
-- =========================================================
