...
-- >>> BEGIN FILE: supabase_bingo_v21_avatar_colors_patch.sql
-- =========================================================
-- V21: Avatar paid color changes (Avatar-9)
-- =========================================================
-- New RPC purchase_avatar_color(p_color_slot, p_color):
--   Validates slot name ('skinColor' only) and hex format,
--   deducts 25 XP, merges color into avatar_data, returns
--   updated {ok, total_xp, level, avatar_data, xp_spent}.
--   Reset to white/default handled client-side via save_student_avatar.
-- =========================================================
...
-- <<< END FILE: supabase_bingo_v21_avatar_colors_patch.sql
