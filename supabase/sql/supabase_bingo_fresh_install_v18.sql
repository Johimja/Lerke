...
--   Deducts 25 XP and saves the chosen color into avatar_data for the given slot.
--   Slots: 'skinColor' (head/face silhouette) or 'accColor' (accessory).
--   Resets are free via save_student_avatar (no XP cost for removing a color).
